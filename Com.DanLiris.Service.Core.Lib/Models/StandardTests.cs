...
{
    public class StandardTests : StandardEntity, IValidatableObject
    {
        [MaxLength(255)]
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (validationResult.Count.Equals(0))
            {
                ...
                if (service.DbContext.Set<FinishType>().Count(r => r._IsDeleted.Equals(false) && r.Id != this.Id && r.Name.Equals(this.Name)) > 0) /* Name Unique */
