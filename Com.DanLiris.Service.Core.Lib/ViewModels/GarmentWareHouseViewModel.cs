...
{
    public class GarmentWareHouseViewModel : BasicViewModel, IValidatableObject
    {
        ...
        {
            IGarmentWareHouseService service = (IGarmentWareHouseService)validationContext.GetService(typeof(IGarmentWareHouseService));
