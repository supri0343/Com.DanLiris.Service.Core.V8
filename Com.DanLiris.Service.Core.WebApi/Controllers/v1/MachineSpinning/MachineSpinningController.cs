...
using ResultFormatter = Com.Danliris.Service.Core.WebApi.Utils.ResultFormatter;
using ResultFormatter2 = Com.Danliris.Service.Core.WebApi.Helpers.ResultFormatter;
...
namespace Com.DanLiris.Service.Core.WebApi.Controllers.v1.MachineSpinning
{
    ...
    public class MachineSpinningController : BaseController<MachineSpinningModel, MachineSpinningViewModel, IMachineSpinningService>
    {
        ...
        public async Task<IActionResult> PostCSVFileAsync()
        {
            ...
            {
                Dictionary<string, object> Result =
                  new ResultFormatter(ApiVersion, General.INTERNAL_ERROR_STATUS_CODE, "Tahun, Delivery atau Kapasitas diisi huruf\n" + ex.Message)
                  .Fail();
        ...
        public IActionResult GetSimple()
        {
            try
            {
                ...
                Dictionary<string, object> Result =
                    new ResultFormatter2(ApiVersion, General.OK_STATUS_CODE, General.OK_MESSAGE)
                    .Ok(result);
